...
int openGPIO(int gpio, int direction )
{
	...
	system("echo -n "4" > /sys/class/gpio/export");

	system("echo -n "0" > /sys/class/gpio/export");
	...
	if (direction = GPIO_DIRECTION_IN)
	{
		if (gpio = GP_4)
		{
			system("echo -n "in" > /sys/class/gpio/gpio6/direction");
		}
		if (gpio = GP_5)
		{
			system("echo -n "in" > /sys/class/gpio/gpio0/direction");
		}
		if (gpio = GP_6)
		{
			system("echo -n "in" > /sys/class/gpio/gpio4/direction");
		}
		if (gpio = GP_7)
		{
			system("echo -n "in" > /sys/class/gpio/gpio38/direction");
		}
		if (gpio = Strobe)
		{
			system("echo -n "in" > /sys/class/gpio/gpio40/direction");
		}
    	...
    	if (direction = GPIO_DIRECTION_OUT)
	{
		if (gpio = GP_4)
		{
			system("echo -n "out" > /sys/class/gpio/gpio6/drive");
		}
		if (gpio = GP_5)
		{
			system("echo -n "out" > /sys/class/gpio/gpio0/drive");
		}
		if (gpio = GP_6)
		{
			system("echo -n "out" > /sys/class/gpio/gpio4/drive");
		}
		if (gpio = GP_7)
		{
			system("echo -n "out" > /sys/class/gpio/gpio38/drive");
		}
		if (gpio = Strobe)
		{
			system("echo -n "out" > /sys/class/gpio/gpio40/drive");
		}
	...
	if (direction = GPIO_DIRECTION_IN)
	{
		if (gpio = GP_4)
		{
			system("echo -n "weak" > /sys/class/gpio/gpio6/drive");
		}
		if (gpio = GP_5)
		{
			system("echo -n "weak" > /sys/class/gpio/gpio0/drive");
		}
		if (gpio = GP_6)
		{
			system("echo -n "weak" > /sys/class/gpio/gpio4/drive");
		}
		if (gpio = GP_7)
		{
			system("echo -n "weak" > /sys/class/gpio/gpio38/drive");
		}
		if (gpio = Strobe)
		{
			system("echo -n "weak" > /sys/class/gpio/gpio40/drive");
		}
	...
	//*********4.Open GPIO for Read / Write**********************
		...
		if (gpio = GP_4)
		{
			system("echo -n "out" > /sys/class/gpio/gpio6/value");
		}
		if (gpio = GP_5)
		{
			system("echo -n "out" > /sys/class/gpio/gpio0/value");
		}
		if (gpio = GP_6)
		{
			system("echo -n "out" > /sys/class/gpio/gpio4/value");
		}
		if (gpio = GP_7)
		{
			system("echo -n "out" > /sys/class/gpio/gpio38/value");
		}
		if (gpio = Strobe)
		{
			system("echo -n "out" > /sys/class/gpio/gpio40/value");
		}
